...
public class DeleteMultipleAreaTest {
	...
	@Test(priority = 0)
	public static void deleteAreaTest() throws Exception {

		driver.findElement(By.xpath("/html/body/table[2]/tbody/tr[2]/td[1]/ul/li[4]/a[3]")).click();
		Thread.sleep(2000);
		driver.findElement(By.xpath("//a[text()='Admin']")).click();
		driver.findElement(By.xpath("/html/body/table[2]/tbody/tr[2]/td[1]/ul/li[4]/a[3]")).click();
		try {
			// Assert.assertEquals(driver.findElement(By.xpath("//a[text()='Area
			// New']")).getText(), "Area New");
		} catch (Exception e) {
			e.printStackTrace();
		}
	}
