...
public class Closemilestone {
	public class Openproject {
		...
		@Test(priority = 0)
		void Openmilestone() throws InterruptedException
		{
			...
			driver.findElement(By.xpath("//*[@id=\"contentwrapper\"]/div[1]/ul/li[2]/a")).click();
			driver.findElement(By.xpath("//*[@id=\"miles_11\"]/tr[1]/td[2]/div/a")).click();
			driver.findElement(By.xpath("//*[@id=\"content-left-in\"]/div/div[2]/ul/li[1]/a")).click();
